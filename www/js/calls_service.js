...
smmsCallService.factory('CallService', function ($http, SettingsService) {

    return {
        getCalls: function () {
            return $http.get(serviceUrl + service + 'list/' + clientKey + '/' + SettingsService.getUserToken());
        },

        getCall: function ($stateParams) {
            return $http.get(serviceUrl + service + $stateParams.itemId + '/' + clientKey + '/' + SettingsService.getUserToken());
        }
    }
});
...
smmsCallService.factory('SettingsService', function () {
